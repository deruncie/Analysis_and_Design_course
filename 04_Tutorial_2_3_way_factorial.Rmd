...
bolting_data = read_csv('data/Bolting_experiment.csv')
```
...
# bolting_data$Temperature = factor(bolting_data$Temperature)
# bolting_data$Fluctuation = factor(bolting_data$Fluctuation)
# bolting_data$Vernalization = factor(bolting_data$Vernalization)
bolting_data$Treatment.V = factor(bolting_data$Treatment.V)
bolting_data$Chamber.ID = factor(bolting_data$Chamber)
```
...
# bolting_data$Vernalization = factor(bolting_data$Vernalization)
bolting_data$Treatment.V = factor(bolting_data$Treatment.V)
# bolting_data$Chamber.ID = factor(bolting_data$Chamber.ID)
